...
export function validateSplits(config: typeof mainConfig): string | null {
	...
	for (const { name, sum } of networks) {
		// A network's splits must sum to 100% (active) or 0% (fully wound down).
	...
	if (!config.base.rewardsEnabled && !config.optimism.rewardsEnabled && !config.ethereum.rewardsEnabled) {
...
export const mainConfig = {
	...
	base: {
		...
		nativePerEpoch: 0,
		markets: 0.70, // 70%
		safetyModule: 0.20, // 20%
		dex: 0.0,
		vaults: 0.10, // 10% - MetaMorpho vault incentives
...
export const merkleCampaignDatas = {
	stkWELL: "",
	...
	cbBTC: "",
	meUSDC: "",
};
